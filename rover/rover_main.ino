...
// so the timed backup distance is repeatable no matter what speed I'm driving.
const uint8_t  BACKUP_SPEED = 200;           // 0-255

//   1. Upload the code, connect, and set the drive speed.
...
// The placeholder below is a guess; I replace it with my own measured value.
