...
> ✅ Confirmed against your build: Nano **5V** powers the **HC-05 VCC** and **HC-SR04 VCC**,
...
divider so you don't slowly damage the module:
...
> If your battery pack exceeds ~12V, **do not** feed the L298N 5V output to the Nano.
