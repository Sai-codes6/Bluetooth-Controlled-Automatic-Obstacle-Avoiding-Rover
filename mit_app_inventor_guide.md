...
the "blocks" below are written as readable pseudo-blocks I assembled by dragging.
...
- App Inventor uses the classic **SPP** profile automatically — there's no need to enter a
...
3. Tap **MANUAL**, then hold **▲**. Place a hand <50cm in front → rover should
   reverse ~50cm and stop, ignoring the held button.
4. Move the hand away, release and press **▲** again → rover resumes.
